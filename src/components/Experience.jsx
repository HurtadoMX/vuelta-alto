    ...
    return [
      {
        ...
        title: `Visionario del Desarrollo Frontend`,
        subtitle: `Reimaginando la interactividad web con React avanzado y arquitecturas modernas de JavaScript.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        title: "Artista de Interfaces de Usuario",
        subtitle: `Creando experiencias digitales memorables mediante diseño intuitivo y tecnologías de vanguardia.`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        title: "Estratega en Interacción Usuario",
        subtitle: ` Elevando la usabilidad y accesibilidad con soluciones innovadoras y prácticas de diseño inclusivo.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
